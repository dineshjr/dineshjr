...
const dineshkumar = {
  ...
  experience: "3+ years in production MERN applications",

  funFact: "I built a LeetCode-grade judge from scratch 🧩",
...
- 🐛 Led a root-cause analysis initiative that **reduced recurring production incidents by 30%**
- 🔀 Introduced Git PR workflow standards and peer review gates — **reduced merge conflict resolution time to near-zero** across two consecutive sprints
...
- 🧩 Engineered a **shared component library** adopted across the entire engineering team — reduced code duplication and cut feature development cycle time
- 🛡️ Implemented error boundaries and structured debugging workflows that **improved sprint velocity** by reducing mean time-to-resolution for production issues
...
|:-------:|:-----:|:----------:|
| 🧑‍💻 **[SoloDev — Full Stack Coding Judge](https://github.com/dineshjr)** | React · TypeScript · Node.js · Express.js · MongoDB · RTK Query · Redux Toolkit · Tailwind CSS · Framer Motion · JWT | Self-engineered LeetCode-equivalent platform · **8-strategy testcase evaluation engine** · sandboxed multi-language execution · JWT + RBAC (admin / moderator / player) · **zero prop-drilling** frontend with RTK Query typed cache & tag invalidation |
...
| 🔀 | **Near-Zero Merge Conflicts** | Introduced Git PR standards and peer review gates — sustained across 2+ consecutive sprints |
| 🧩 | **LeetCode-Grade Judge — Built from Scratch** | 8-strategy testcase engine: exact match, deep equality, linked list, binary tree, approximate numeric, custom comparators & more |
| 🎨 | **3 Client SPAs — Zero Visual Regressions** | All products matched 1:1 to Figma specs at Cameo Corporate Services |
| ☁️ | **AWS Certified Developer Associate** | Actively targeting certification — EC2, S3, Lambda, RDS, VPC, CloudFront, CloudWatch |
...
|:---------:|:--------------:|:-------:|
| B.Com (Computer Applications) | Ramakrishna Mission Vivekananda College | 2018 – 2021 |
